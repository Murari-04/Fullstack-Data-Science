...
dataset = pd.read_csv(r"C:\Users\Lenovo\Desktop\FSDS\july\9th - Poly\1.POLYNOMIAL REGRESSION\emp_sal.csv")
...
knn_regressor = KNeighborsRegressor(n_neighbors=2,weights='distance',algorithm='auto',p=2)
